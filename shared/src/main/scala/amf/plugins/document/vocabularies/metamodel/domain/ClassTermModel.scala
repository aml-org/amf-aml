...
object ClassTermModel extends DomainElementModel {
  ...
  val Name = Field(Str, Namespace.Core + "name",
    ModelDoc(ModelVocabularies.Core, "name", "Name of the ClassTerm"))
  ...
  override def fields: List[Field] = Name :: DisplayName :: Description :: Properties :: SubClassOf :: DomainElementModel.fields
